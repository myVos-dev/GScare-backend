...
public class RequestRegisterEmployeeJsonBuilder
{
    public static RequestEmployeeJson Build()
    {
        ...
        return new Faker<RequestEmployeeJson>()
            ...
            .RuleFor(r => r.FotoCertificadoDoCurso, faker => faker.Address.CountryCode())
            ...
            .RuleFor(r => r.FotoMei, faker => faker.Company.CompanyName())
            .RuleFor(r => r.FotoNadaConsta, faker => faker.Lorem.Sentence());
    }
}
